...
DEFAULT_NAME = "jaxmarl_mappo"
JOB_TYPE = "jaxmarl_mappo"
SEED = None

# Hyperparameters from "The Surprising Effectiveness of PPO in Cooperative,
# Multi-Agent Games" (Yu et al., 2022) for MPE environments.
# Source: https://github.com/marlbenchmark/on-policy
...
def train(
    ...
    exp_name = (
        f"{'test_' if test else ''}{env_name}_mappo_{time.strftime('%m_%d-%H_%M_%S')}"
    )
